...
var kt = (t, e, n) => e in t ? xt(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n;
var tt = (t, e, n) => kt(t, typeof e != "symbol" ? e + "" : e, n), ut = (t, e, n) => e.has(t) || ct("Cannot " + n);
var o = (t, e, n) => (ut(t, e, "read from private field"), n ? n.call(t) : e.get(t)), c = (t, e, n) => e.has(t) ? ct("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, n), a = (t, e, n, i) => (ut(t, e, "write to private field"), i ? i.call(t, n) : e.set(t, n), n);
const wt = function() {
  ...
  if (arguments.length > 2) {
    const s = { string: String, decimal: vt, number: Number, boolean: ft, bool: ft, color: St, url: Tt };
  ...
  if (n) {
    if (typeof n == "string" && (n = jt(n)), typeof n != "object")
  ...
  return new Promise((i, s) => {
    ...
    const u = function() {
      clearTimeout(l), t.removeEventListener(bt, u), t.style.display = r, nt(t, [
        e,
        n
      ]), i();
    };
...
window.addEventListener("message", function(t) {
  ...
  if (t.data)
    if (typeof t.data == "string")
      ...
      e = t.data;
  e.type && Array.isArray(E == null ? void 0 : E[e.type]) && E[e.type].length && (E[e.type] = E[e.type].filter((n) => {
    try {
      return n(t, e) !== -1;
    } catch (i) {
...
const yt = function(t, e) {
  typeof t == "string" && typeof e == "function" && (E.hasOwnProperty(t) || (E[t] = []), E[t].push(e));
};
function rt(...t) {
  let e = {};
  if (t.length === 1)
...
const st = function(t) {
  if (t.key === "Escape") {
    const e = M.pop();
    M.length === 0 && document.removeEventListener("keydown", st), typeof e == "function" && e();
  }
}, gt = {
  bind: function(t) {
    typeof t == "function" && M.push(t), M.length === 1 && document.addEventListener("keydown", st);
  },
  unbind: function(t) {
    typeof t == "function" && (M = M.filter((e) => e !== t)), M.length === 0 && document.removeEventListener("keydown", st);
  }
}, Ht = "vt0z5W_button", Pt = "vt0z5W_chat", m = {
  button: Ht,
...
var f, I, p, D, P, y, x, C, z, F, W, _, B, R, k;
class Et {
  constructor({ id: e, url: n, button: i, closeOnEscape: s = !0, autoload: r, autoopen: l = !1, autoopenDelay: u, onBeforeEmbedChat: d, onChatLoaded: b, onBeforeOpen: O, onAfterOpen: Y, onBeforeClose: Z, onAfterClose: j }) {
    c(this, f);
    c(this, I);
    c(this, p);
    c(this, D);
    ...
    tt(this, "open", () => new Promise(async (e, n) => {
      if (o(this, y) < 1 && await this.load(), o(this, x) && !o(this, C)) {
        e();
        return;
      }
      try {
        a(this, C, !0), typeof o(this, W) == "function" && await o(this, W).call(this), o(this, f) && await X(
          o(this, f),
        ...
        ), typeof o(this, _) == "function" && await o(this, _).call(this), et(o(this, p), "getchat.messenger.repaint"), a(this, C, !1), a(this, x, !0), et(o(this, p), "getchat.chat.input.focus"), o(this, P) && gt.bind(this.close);
      } catch (i) {
        n(i);
      }
      e();
    ...
    tt(this, "close", () => new Promise(async (e, n) => {
      ...
      o(this, P) && gt.unbind(this.close);
      try {
        a(this, C, !0), typeof o(this, B) == "function" && await o(this, B).call(this), await X(
          o(this, I),
        ...
        ), a(this, C, !0), a(this, x, !1), typeof o(this, R) == "function" && await o(this, R).call(this), e();
      } catch (i) {
        n(i);
      }
    }));
    if (a(this, D, n), a(this, P, s), i instanceof Element && a(this, f, i), typeof d != "function")
      throw new Error("onBeforeEmbedChat parameter must be a function, " + typeof d + " given");
    a(this, z, d);
    let h;
    l && (l !== "once" || !window.localStorage.getItem("getchat_opened")) && (h = isNaN(u) ? this.open : () => {
      setTimeout(this.open, u * 1e3);
    }), a(this, F, () => {
      a(this, y, 1), h && h(), typeof b == "function" && b(), a(this, z, null), a(this, F, null);
    }), r && this.load(!1), a(this, W, O), a(this, _, Y), a(this, B, Z), a(this, R, j), o(this, f) && o(this, f).addEventListener("click", () => {
      this.toggle();
    });
    {
      let J, K;
      ...
      a(this, k, { promise: g, resolve: J, reject: K }), o(this, f) && g.then(async () => {
        var A;
        const w = await this.rpc("getchat.messenger.getUnreads");
        o(this, f).setBadge(((A = w == null ? void 0 : w.total) == null ? void 0 : A.messages) ?? 0);
      });
    }
  }
  whenReady() {
    var e;
    return (e = o(this, k)) != null && e.promise ? o(this, k).promise : o(this, y) === 1 ? Promise.resolve() : new Promise();
  }
  load(e = !0) {
    return new Promise((n, i) => {
      ...
      try {
        ...
        a(this, y, 0);
        const r = o(this, z).call(this);
        if (!(r instanceof Element))
          throw new Error("onBeforeEmbedChat must return an Element");
        a(this, I, r), e && ((s = o(this, f)) == null || s.setState("loading")), a(this, p, It(r, o(this, D), {}, () => {
          var l, u;
          o(this, F).call(this), (l = o(this, f)) == null || l.setState("loaded"), a(this, y, 1), n(), (u = o(this, k)) == null || u.resolve(), a(this, k, null);
        }));
      } catch (r) {
        i(r);
      }
  ...
  toggle() {
    return new Promise(async (e, n) => {
      ...
      o(this, x) ? await this.close() : await this.open(), e();
    });
  }
  ...
  rpc(e, n, i = 5e3) {
    return new Promise((s, r) => {
      ...
      let l;
      const u = (b, O) => (clearTimeout(l), s(O == null ? void 0 : O.data), -1), d = et(o(this, p), e, n);
      d && (rt("response." + d, u, o(this, p)), i > 0 && (l = setTimeout(() => {
        r("Timeout");
      }, i)));
    });
  }
}
f = new WeakMap(), I = new WeakMap(), p = new WeakMap(), D = new WeakMap(), P = new WeakMap(), y = new WeakMap(), x = new WeakMap(), C = new WeakMap(), z = new WeakMap(), F = new WeakMap(), W = new WeakMap(), _ = new WeakMap(), B = new WeakMap(), R = new WeakMap(), k = new WeakMap();
...
class N extends HTMLElement {
  ...
  connectedCallback() {
    ...
    })), o(this, $).observe(this, { attributes: !0 });
  }
  disconnectedCallback() {
    o(this, $).disconnect();
  }
  setChatInstance(n) {
    !o(this, V) && n instanceof Et && a(this, V, n);
  }
  getChatInstance() {
    return o(this, V);
  }
  setState(n) {
    n = n.toLowerCase(), n === "loading" ? U(this, "loading") : (nt(this, "loading"), n === "loaded" && this.shadowRoot.querySelector(".loader").remove());
  }
  setBadge(n) {
    n = vt(n);
    const i = this.shadowRoot.querySelector(".unreads");
    i && (n > 0 ? (i.textContent = n, U(i, "unreads--visible")) : nt(i, "unreads--visible"));
  }
  setStyles(n) {
  ...
  render() {
    o(this, G) || (this.shadowRoot.innerHTML = `
...
V = new WeakMap(), G = new WeakMap(), $ = new WeakMap();
...
async function zt({
  ...
  if (g.id = K, e || (e = m.button), e = pt(e), e && U(g, e), ot(O) && Object.assign(g.style, O), (lt = N.supportedAttributes) != null && lt.length)
    for (let S of N.supportedAttributes)
      J[S] && g.setAttribute("data-" + S, J[S]);
  b.appendChild(g);
  let w, A, Q = !1;
  const q = new Et({
    url: it(t),
    ...
    onBeforeEmbedChat: function() {
      let T = !0;
      return h instanceof Element || (h = document.createElement("div"), T = !1), h.className = m.chat, ot(j) ? j = Object.assign({}, j, { display: "none" }) : j = { display: "none" }, Object.assign(h.style, j), Y && U(h, pt(Y)), (!T || !document.body.contains(h)) && (Z instanceof Element || (Z = document.body), Z.appendChild(h)), h;
    },
    onChatLoaded: function() {
      window.localStorage.setItem("getchat_opened", "1");
      const S = window.innerHeight, T = q.getChatNode();
      if (T) {
        let { display: Ct, visibility: Ot, position: At, top: L, right: Ft, bottom: v, left: Wt } = getComputedStyle(T);
        const H = {
          display: Ct,
          visibility: Ot
        };
        Object.assign(T.style, { display: "block", visibility: "hidden" }), requestAnimationFrame(() => {
          At === "fixed" ? (v = ht(v, "auto"), L = ht(L, "auto"), v !== "auto" && (v != null && v.value) ? L === "auto" && (H.top = v.value + v.unit, H.height = "auto") : L !== "auto" && L.value && v === "auto" && (H.bottom = L.value + L.unit, H.height = "auto")) : H.height = `${Math.min(S - 20, 500)}px`, Object.assign(T.style, H);
        });
      }
    },
    onBeforeOpen: function() {
      window.innerWidth <= d && (w = window.scrollY || window.pageYOffset, A = getComputedStyle(document.body).position, Q = !0);
    },
  ...
  return g.setChatInstance(q), q.addEventListener("getchat.close", function(S) {
    q.close();
  }), q;
}
const Bt = {
